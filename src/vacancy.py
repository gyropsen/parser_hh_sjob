class Vacancy:
    ...
    def __init__(self, profession: str = None, requirement: str = None, address: str = None,
                 currency: str = None, client_name: str = None, link_client: str = None, link_vacancy: str = None,
                 payment_from: int = None, payment_to: int = None):
